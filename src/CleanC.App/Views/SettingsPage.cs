...
public sealed partial class MainWindow
{
 ...
 void ShowSettings()
 {
  ...
  var about=Ui.Stack(16,logo,Ui.T("CleanC  1.7.0",20,true),Ui.T("只清理能够确认安全的数据。",14),Ui.T("无广告、无后台驻留、不上传用户文件、不做遥测。\n仅授权请求发送授权码、设备公钥、设备标识与软件版本。\nCopyright © 2026 CleanC",12,false,Ui.Muted));
  settingsViewCache=Ui.Stack(24,Heading("MAKE IT YOURS","设置","外观、扫描偏好和授权信息。"),Ui.Card(Ui.Stack(20,Ui.T("外观与性能",20,true),theme,quiet)),Ui.Card(license),Ui.Card(recovery),Ui.Card(logs),Ui.Card(Ui.Stack(12,Ui.T("软件更新",20,true),Ui.T("当前版本 1.7.0 · 从 GitHub 官方项目获取更新",13,false,Ui.Muted),Ui.Button("检查更新",()=>_=CheckForUpdatesAsync(),true))),Ui.Card(about));
